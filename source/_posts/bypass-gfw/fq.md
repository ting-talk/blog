...
- 用手机或者电脑的本机浏览器打开 [ssrcloud](https://ntt-co-jp.club/#/auth/register?code=o4rW)，或者复制下面这个网址，粘贴到浏览器的地址栏：
  ```http
  ntt-co-jp.club/#/auth/register?code=o4rW
  ```
  - 邀请码是 `o4rW`，`o` 是字母，不是数字 `0`。
